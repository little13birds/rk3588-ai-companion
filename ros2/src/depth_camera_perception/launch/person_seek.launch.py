...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("status_topic", default_value="/depth_camera/person_seek_status"),
            ...
            DeclareLaunchArgument("stop_distance_m", default_value="0.80"),
            DeclareLaunchArgument("stop_tolerance_m", default_value="0.05"),
            DeclareLaunchArgument("search_angular_z", default_value="0.25"),
            ...
            DeclareLaunchArgument("approach_max_forward_mps", default_value="0.40"),
            DeclareLaunchArgument("approach_slow_forward_mps", default_value="0.10"),
            DeclareLaunchArgument("slowdown_distance_m", default_value="1.20"),
            DeclareLaunchArgument("approach_angular_gain", default_value="0.8"),
            DeclareLaunchArgument("approach_max_angular_z", default_value="0.25"),
            DeclareLaunchArgument("center_tolerance_fraction", default_value="0.08"),
                ...
                parameters=[
                    {
                        ...
                        "stop_tolerance_m": LaunchConfiguration("stop_tolerance_m"),
                        ...
                        "approach_max_forward_mps": LaunchConfiguration("approach_max_forward_mps"),
                        "approach_slow_forward_mps": LaunchConfiguration("approach_slow_forward_mps"),
                        "slowdown_distance_m": LaunchConfiguration("slowdown_distance_m"),
