"""
Full navigation: Cartographer localization + Chassis + Simple Navigator
Usage: ros2 launch simple_nav simple_nav.launch.py
"""
import os
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                os.path.expanduser("~/carto_config"),
                "-configuration_basename", "test_localization.lua",
                "-load_state_filename",
                os.path.expanduser("~/maps/my_room.pbstream"),
            ],
        ),
